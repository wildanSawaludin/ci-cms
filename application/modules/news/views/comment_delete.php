...
<form class="delete" action="<?php  echo site_url('admin/news/comments/delete/'.$id.'/1')?>" method="post">
	<p>
		<input type="button" name="noway" value="<?php  echo __("No", $this->template['module'])?>" onclick="parent.location='<?php  echo site_url('admin/news/comments')?>'" class="input-submit" style="margin-right: 2em;" />
