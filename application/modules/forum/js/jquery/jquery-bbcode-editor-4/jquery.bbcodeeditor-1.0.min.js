(function($) {
	...
	{	
		...
		if(options.youtube != false) options.youtube.click(function() {print_bbc('http://www.youtube.com/watch?v=8kxC8CzwIOY','[youtube]','[/youtube]')});
		if(options.dailymotion != false) options.dailymotion.click(function() {print_bbc('http://www.dailymotion.com/video/xdlwsx_aina-quach-itv-telessonne_music','[dailymotion]','[/dailymotion]')});
		...
		if(options.image != false) options.image.click(function() {print_bbc($(this).html(),'[img]','[/img]')});
