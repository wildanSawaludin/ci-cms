...
<ul class="manage">
	...
	<li><a href="<?php  echo site_url('admin')?>" class="last"><?php  _e("Cancel", $module)?></a></li>
</ul>
...
<?php  if ($i % 2 != 0): $rowClass = 'odd'; else: $rowClass = 'even'; endif;?>
		<tr class="<?php  echo $rowClass?>">
				...
				<td>
				<a href="<?php  echo site_url('admin/page/move/up/'. $page['id'])?>"><img src="<?php  echo site_url('application/views/" . $this->system->theme_dir . "/admin/images/moveup.gif')?>" width="16" height="16" title="<?php  echo __("Move up", $this->template['module'])?>" alt="<?php  echo __("Move up", $this->template['module'])?>"/></a>
				</td><td>
				<a href="<?php  echo site_url('admin/page/move/down/'. $page['id'])?>"><img src="<?php  echo site_url('application/views/" . $this->system->theme_dir . "/admin/images/movedown.gif')?>" width="16" height="16" title="<?php  echo __("Move down", $this->template['module'])?>" alt="<?php  echo __("Move down", $this->template['module'])?>"/></a></td>
