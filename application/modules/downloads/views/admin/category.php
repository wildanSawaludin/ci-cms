...
<?php  if ($i % 2 != 0): $rowClass = 'odd'; else: $rowClass = 'even'; endif;?>
		<tr class="<?php  echo $rowClass?>">
				...
				<td>
				<a href="<?php  echo site_url('admin/downloads/category/move/up/'. $row['id'])?>"><img src="<?php  echo site_url('application/views/admin/images/moveup.gif')?>" width="16" height="16" title="<?php  echo __("Move up", $this->template['module'])?>" alt="<?php  echo __("Move up", 'downloads')?>"/></a>
				<a href="<?php  echo site_url('admin/downloads/category/move/down/'. $row['id'])?>"><img src="<?php  echo site_url('application/views/admin/images/movedown.gif')?>" width="16" height="16" title="<?php  echo __("Move down", $this->template['module'])?>" alt="<?php  echo __("Move down", 'downloads')?>"/></a></td>
