...
<div id="left">
	...
	<div id='newsbox' class="box-gris">
		...
		<?php foreach($rows as $row):?>
			...
			<h2><a href="<?php echo site_url('news/' . $row['uri'])?>" class="more"><?php echo $row['title']?></a></h2>
			<?php if ($row['image']): ?>
			<img src="<?php echo site_url('media/images/s/' . $row['image']['file'])?>" />
			<?php endif; ?>
			<?php echo strip_tags($row['summary']) ?> <a href="<?php echo site_url('news/' . $row['uri'])?>" class="more"><?php echo __("More", "default")?>&gt;&gt;</a>
			<div class="clear"></div>
		<?php endforeach;?>
	</div>
	<?php endif; ?>				
...
<div id="right">
        <div id="login">
            ...
            <a href="<?php echo site_url('member/adino') ?>"><?php echo __("Lost password?", "default")?></a> | <a href="<?php echo site_url('member/signup');?>"><?php echo __("Sign up", "default") ?></a>
            <?php else : ?>
